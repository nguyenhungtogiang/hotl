...
<div class="mg-page">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5">
                <h2 class="mg-sec-left-title">Gửi qua E-mail</h2>
                <?php echo $result; ?>
                ...
                <input type="submit" class="btn btn-dark-main pull-right" value="Gửi">
                <?php echo form_close(); ?>
            </div>
            <div class="col-md-7">
                <h2 class="mg-sec-left-title">Địa chỉ văn phòng</h2>
